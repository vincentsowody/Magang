            ...
            async function loadDocuments() {
                try {
                    const res = await fetch(window.APP_CONFIG.apiBaseUrl + '/admin/documents');
            ...
            async function finalizeUpload(name, btn) {
                ...
                try {
                    ...
                    const response = await fetch(window.APP_CONFIG.apiBaseUrl + '/admin/documents', {
                        method: 'POST',
                        body: formData
                    });
        ...
        <div class="doc-file-row">
            ...
            async function deleteDoc(loc, id) {
                ...
                try {
                    const res = await fetch(window.APP_CONFIG.apiBaseUrl + '/admin/documents/' + id, { method: 'DELETE' });
